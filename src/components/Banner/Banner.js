...
const CustomSlide = ({ Subtext, imgSrc, text, buttonLink, buttonText }) => (
  ...
  >
    <div
      style={{
        maxWidth: "350px", // Adjust the maxWidth as needed
...
const Banner = () => {
  ...
  const slides = [
    {
      imgSrc: bannerImgOne,
      text: "Enhance Your Building Experience",
      Subtext:
    ...
    },
    {
      ...
      text: "Quality Building Solutions",
      Subtext:
    ...
    },
    {
      ...
      Subtext:
        "Maximize productivity with our advanced engineers and high-quality consumables. ",
      buttonLink: "/contact",
